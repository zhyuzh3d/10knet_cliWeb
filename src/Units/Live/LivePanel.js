...
class com extends Component {
    state = {
        ...
        browserAddr: global.$conf.browser.defaultAddr, //默认浏览器页面
        browserAddrTemp: global.$conf.browser.defaultAddr, //浏览器地址输入栏地址，点击后更新
    ...
    render() {
        ...
        //显示右侧面板开关
        let mainPartBtn = h(Tooltip, { title: '显示右侧面板' }, [h(Button, {
            className: css.btn,
            style: {
                background: 'inherit',
